...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    danger: 'bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 focus:ring-red-500'
  };
  ...
  const combinedClassName = `${baseClasses} ${variantClasses[variant]} ${size !== 'md' ? sizeClasses[size] : ''} ${className}`;
